// de1_soc_alternative_mm_interconnect_3.v
...
`timescale 1 ps / 1 ps
module de1_soc_alternative_mm_interconnect_3 (
	...
	wire  [119:0] hps_master_master_translator_avalon_universal_master_0_agent_cp_data;          // hps_master_master_translator_avalon_universal_master_0_agent:cp_data -> addr_router:sink_data
	...
	wire  [119:0] limiter_rsp_src_data;                                                          // limiter:rsp_src_data -> hps_master_master_translator_avalon_universal_master_0_agent:rp_data
	...
	wire  [119:0] cmd_xbar_mux_src_data;                                                         // cmd_xbar_mux:src_data -> width_adapter:in_data
	...
	wire  [227:0] width_adapter_src_data;                                                        // width_adapter:out_data -> hps_0_f2h_axi_slave_agent:write_cp_data
	...
	wire  [119:0] cmd_xbar_mux_001_src_data;                                                     // cmd_xbar_mux_001:src_data -> width_adapter_001:in_data
	...
	wire  [227:0] width_adapter_001_src_data;                                                    // width_adapter_001:out_data -> hps_0_f2h_axi_slave_agent:read_cp_data
	...
	wire  [119:0] width_adapter_002_src_data;                                                    // width_adapter_002:out_data -> rsp_xbar_demux:sink_data
	...
	wire  [119:0] width_adapter_003_src_data;                                                    // width_adapter_003:out_data -> rsp_xbar_demux_001:sink_data
	...
	de1_soc_alternative_mm_interconnect_3_addr_router addr_router (
	...
	de1_soc_alternative_mm_interconnect_3_id_router id_router (
	...
	de1_soc_alternative_mm_interconnect_3_id_router id_router_001 (
	...
	de1_soc_alternative_mm_interconnect_3_cmd_xbar_demux cmd_xbar_demux (
		.clk                (pll_0_outclk0_clk),                                              //        clk.clk
		.reset              (hps_master_master_translator_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	de1_soc_alternative_mm_interconnect_3_cmd_xbar_mux cmd_xbar_mux (
		.clk                 (pll_0_outclk0_clk),                                                //       clk.clk
		.reset               (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_alternative_mm_interconnect_3_cmd_xbar_mux cmd_xbar_mux_001 (
		.clk                 (pll_0_outclk0_clk),                                                //       clk.clk
		.reset               (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_alternative_mm_interconnect_3_rsp_xbar_demux rsp_xbar_demux (
		.clk                (pll_0_outclk0_clk),                                                //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_alternative_mm_interconnect_3_rsp_xbar_demux rsp_xbar_demux_001 (
		.clk                (pll_0_outclk0_clk),                                                //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_alternative_mm_interconnect_3_rsp_xbar_mux rsp_xbar_mux (
		.clk                 (pll_0_outclk0_clk),                                              //       clk.clk
		.reset               (hps_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
