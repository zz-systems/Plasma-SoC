...
// 
// Generated using ACDS version 13.1 162 at 2018.09.07.06:20:40
...
module de1_soc_mm_interconnect_2 (
	...
	wire  [227:0] cmd_xbar_mux_src_data;                                                         // cmd_xbar_mux:src_data -> hps_0_f2h_axi_slave_agent:write_cp_data
	...
	wire  [227:0] cmd_xbar_mux_001_src_data;                                                     // cmd_xbar_mux_001:src_data -> hps_0_f2h_axi_slave_agent:read_cp_data
	...
	wire  [227:0] dma_0_read_master_translator_avalon_universal_master_0_agent_cp_data;          // dma_0_read_master_translator_avalon_universal_master_0_agent:cp_data -> addr_router:sink_data
	...
	wire  [227:0] hps_0_f2h_axi_slave_agent_write_rp_data;                                       // hps_0_f2h_axi_slave_agent:write_rp_data -> id_router:sink_data
	...
	wire  [227:0] id_router_src_data;                                                            // id_router:src_data -> rsp_xbar_demux:sink_data
	...
	wire  [227:0] hps_0_f2h_axi_slave_agent_read_rp_data;                                        // hps_0_f2h_axi_slave_agent:read_rp_data -> id_router_001:sink_data
	...
	wire  [227:0] id_router_001_src_data;                                                        // id_router_001:src_data -> rsp_xbar_demux_001:sink_data
	...
	wire  [227:0] addr_router_src_data;                                                          // addr_router:src_data -> limiter:cmd_sink_data
	...
	wire  [227:0] limiter_cmd_src_data;                                                          // limiter:cmd_src_data -> cmd_xbar_demux:sink_data
	...
	wire  [227:0] rsp_xbar_mux_src_data;                                                         // rsp_xbar_mux:src_data -> limiter:rsp_sink_data
	...
	wire  [227:0] limiter_rsp_src_data;                                                          // limiter:rsp_src_data -> dma_0_read_master_translator_avalon_universal_master_0_agent:rp_data
	wire    [1:0] limiter_rsp_src_channel;                                                       // limiter:rsp_src_channel -> dma_0_read_master_translator_avalon_universal_master_0_agent:rp_channel
	...
	wire  [227:0] cmd_xbar_demux_src0_data;                                                      // cmd_xbar_demux:src0_data -> cmd_xbar_mux:sink0_data
	...
	wire  [227:0] cmd_xbar_demux_src1_data;                                                      // cmd_xbar_demux:src1_data -> cmd_xbar_mux_001:sink0_data
	...
	wire  [227:0] rsp_xbar_demux_src0_data;                                                      // rsp_xbar_demux:src0_data -> rsp_xbar_mux:sink0_data
	...
	wire  [227:0] rsp_xbar_demux_001_src0_data;                                                  // rsp_xbar_demux_001:src0_data -> rsp_xbar_mux:sink1_data
	...
	de1_soc_mm_interconnect_2_id_router id_router_001 (
	...
	de1_soc_mm_interconnect_2_cmd_xbar_mux cmd_xbar_mux_001 (
		.clk                 (pll_0_outclk0_clk),                                                //       clk.clk
		.reset               (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_mm_interconnect_2_rsp_xbar_demux rsp_xbar_demux_001 (
		.clk                (pll_0_outclk0_clk),                                                //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
