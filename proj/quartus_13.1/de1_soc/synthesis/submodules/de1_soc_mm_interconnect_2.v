...
// 
// Generated using ACDS version 13.1 162 at 2018.09.10.21:24:08
...
module de1_soc_mm_interconnect_2 (
	...
	wire  [126:0] plasma_soc_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rp_data;                    // plasma_soc_0_avalon_slave_0_translator_avalon_universal_slave_0_agent:rp_data -> id_router:sink_data
	...
	wire  [126:0] burst_adapter_source0_data;                                                                       // burst_adapter:source0_data -> plasma_soc_0_avalon_slave_0_translator_avalon_universal_slave_0_agent:cp_data
	...
	wire    [2:0] burst_adapter_source0_channel;                                                                    // burst_adapter:source0_channel -> plasma_soc_0_avalon_slave_0_translator_avalon_universal_slave_0_agent:cp_channel
	...
	wire  [126:0] cmd_xbar_demux_002_src0_data;                                                                     // cmd_xbar_demux_002:src0_data -> cmd_xbar_mux:sink2_data
	...
	wire  [126:0] rsp_xbar_demux_src2_data;                                                                         // rsp_xbar_demux:src2_data -> rsp_xbar_mux_002:sink0_data
	...
	wire          rsp_xbar_mux_src_endofpacket;                                                                     // rsp_xbar_mux:src_endofpacket -> width_adapter:in_endofpacket
	wire          rsp_xbar_mux_src_valid;                                                                           // rsp_xbar_mux:src_valid -> width_adapter:in_valid
	wire          rsp_xbar_mux_src_startofpacket;                                                                   // rsp_xbar_mux:src_startofpacket -> width_adapter:in_startofpacket
	wire  [126:0] rsp_xbar_mux_src_data;                                                                            // rsp_xbar_mux:src_data -> width_adapter:in_data
	wire    [2:0] rsp_xbar_mux_src_channel;                                                                         // rsp_xbar_mux:src_channel -> width_adapter:in_channel
	wire          rsp_xbar_mux_src_ready;                                                                           // width_adapter:in_ready -> rsp_xbar_mux:src_ready
	wire          width_adapter_src_endofpacket;                                                                    // width_adapter:out_endofpacket -> hps_0_h2f_axi_master_agent:write_rp_endofpacket
	wire          width_adapter_src_valid;                                                                          // width_adapter:out_valid -> hps_0_h2f_axi_master_agent:write_rp_valid
	wire          width_adapter_src_startofpacket;                                                                  // width_adapter:out_startofpacket -> hps_0_h2f_axi_master_agent:write_rp_startofpacket
	wire  [234:0] width_adapter_src_data;                                                                           // width_adapter:out_data -> hps_0_h2f_axi_master_agent:write_rp_data
	wire          width_adapter_src_ready;                                                                          // hps_0_h2f_axi_master_agent:write_rp_ready -> width_adapter:out_ready
	wire    [2:0] width_adapter_src_channel;                                                                        // width_adapter:out_channel -> hps_0_h2f_axi_master_agent:write_rp_channel
	wire          rsp_xbar_mux_001_src_endofpacket;                                                                 // rsp_xbar_mux_001:src_endofpacket -> width_adapter_001:in_endofpacket
	wire          rsp_xbar_mux_001_src_valid;                                                                       // rsp_xbar_mux_001:src_valid -> width_adapter_001:in_valid
	wire          rsp_xbar_mux_001_src_startofpacket;                                                               // rsp_xbar_mux_001:src_startofpacket -> width_adapter_001:in_startofpacket
	wire  [126:0] rsp_xbar_mux_001_src_data;                                                                        // rsp_xbar_mux_001:src_data -> width_adapter_001:in_data
	wire    [2:0] rsp_xbar_mux_001_src_channel;                                                                     // rsp_xbar_mux_001:src_channel -> width_adapter_001:in_channel
	wire          rsp_xbar_mux_001_src_ready;                                                                       // width_adapter_001:in_ready -> rsp_xbar_mux_001:src_ready
	wire          width_adapter_001_src_endofpacket;                                                                // width_adapter_001:out_endofpacket -> hps_0_h2f_axi_master_agent:read_rp_endofpacket
	wire          width_adapter_001_src_valid;                                                                      // width_adapter_001:out_valid -> hps_0_h2f_axi_master_agent:read_rp_valid
	wire          width_adapter_001_src_startofpacket;                                                              // width_adapter_001:out_startofpacket -> hps_0_h2f_axi_master_agent:read_rp_startofpacket
	wire  [234:0] width_adapter_001_src_data;                                                                       // width_adapter_001:out_data -> hps_0_h2f_axi_master_agent:read_rp_data
	wire          width_adapter_001_src_ready;                                                                      // hps_0_h2f_axi_master_agent:read_rp_ready -> width_adapter_001:out_ready
	wire    [2:0] width_adapter_001_src_channel;                                                                    // width_adapter_001:out_channel -> hps_0_h2f_axi_master_agent:read_rp_channel
	wire          addr_router_src_endofpacket;                                                                      // addr_router:src_endofpacket -> width_adapter_002:in_endofpacket
	wire          addr_router_src_valid;                                                                            // addr_router:src_valid -> width_adapter_002:in_valid
	wire          addr_router_src_startofpacket;                                                                    // addr_router:src_startofpacket -> width_adapter_002:in_startofpacket
	wire  [234:0] addr_router_src_data;                                                                             // addr_router:src_data -> width_adapter_002:in_data
	wire    [2:0] addr_router_src_channel;                                                                          // addr_router:src_channel -> width_adapter_002:in_channel
	wire          addr_router_src_ready;                                                                            // width_adapter_002:in_ready -> addr_router:src_ready
	wire          width_adapter_002_src_endofpacket;                                                                // width_adapter_002:out_endofpacket -> cmd_xbar_demux:sink_endofpacket
	wire          width_adapter_002_src_valid;                                                                      // width_adapter_002:out_valid -> cmd_xbar_demux:sink_valid
	wire          width_adapter_002_src_startofpacket;                                                              // width_adapter_002:out_startofpacket -> cmd_xbar_demux:sink_startofpacket
	wire  [126:0] width_adapter_002_src_data;                                                                       // width_adapter_002:out_data -> cmd_xbar_demux:sink_data
	wire          width_adapter_002_src_ready;                                                                      // cmd_xbar_demux:sink_ready -> width_adapter_002:out_ready
	wire    [2:0] width_adapter_002_src_channel;                                                                    // width_adapter_002:out_channel -> cmd_xbar_demux:sink_channel
	wire          addr_router_001_src_endofpacket;                                                                  // addr_router_001:src_endofpacket -> width_adapter_003:in_endofpacket
	wire          addr_router_001_src_valid;                                                                        // addr_router_001:src_valid -> width_adapter_003:in_valid
	wire          addr_router_001_src_startofpacket;                                                                // addr_router_001:src_startofpacket -> width_adapter_003:in_startofpacket
	wire  [234:0] addr_router_001_src_data;                                                                         // addr_router_001:src_data -> width_adapter_003:in_data
	wire    [2:0] addr_router_001_src_channel;                                                                      // addr_router_001:src_channel -> width_adapter_003:in_channel
	wire          addr_router_001_src_ready;                                                                        // width_adapter_003:in_ready -> addr_router_001:src_ready
	wire          width_adapter_003_src_endofpacket;                                                                // width_adapter_003:out_endofpacket -> cmd_xbar_demux_001:sink_endofpacket
	wire          width_adapter_003_src_valid;                                                                      // width_adapter_003:out_valid -> cmd_xbar_demux_001:sink_valid
	wire          width_adapter_003_src_startofpacket;                                                              // width_adapter_003:out_startofpacket -> cmd_xbar_demux_001:sink_startofpacket
	wire  [126:0] width_adapter_003_src_data;                                                                       // width_adapter_003:out_data -> cmd_xbar_demux_001:sink_data
	wire          width_adapter_003_src_ready;                                                                      // cmd_xbar_demux_001:sink_ready -> width_adapter_003:out_ready
	wire    [2:0] width_adapter_003_src_channel;                                                                    // width_adapter_003:out_channel -> cmd_xbar_demux_001:sink_channel
	...
	altera_merlin_axi_master_ni #(
		...
		.write_rp_valid         (width_adapter_src_valid),                                           //         write_rp.valid
		.write_rp_data          (width_adapter_src_data),                                            //                 .data
		.write_rp_channel       (width_adapter_src_channel),                                         //                 .channel
		.write_rp_startofpacket (width_adapter_src_startofpacket),                                   //                 .startofpacket
		.write_rp_endofpacket   (width_adapter_src_endofpacket),                                     //                 .endofpacket
		.write_rp_ready         (width_adapter_src_ready),                                           //                 .ready
		...
		.read_rp_valid          (width_adapter_001_src_valid),                                       //          read_rp.valid
		.read_rp_data           (width_adapter_001_src_data),                                        //                 .data
		.read_rp_channel        (width_adapter_001_src_channel),                                     //                 .channel
		.read_rp_startofpacket  (width_adapter_001_src_startofpacket),                               //                 .startofpacket
		.read_rp_endofpacket    (width_adapter_001_src_endofpacket),                                 //                 .endofpacket
		.read_rp_ready          (width_adapter_001_src_ready),                                       //                 .ready
	...
	de1_soc_mm_interconnect_2_addr_router addr_router (
	...
	de1_soc_mm_interconnect_2_addr_router addr_router_001 (
	...
	de1_soc_mm_interconnect_2_addr_router_002 addr_router_002 (
	...
	de1_soc_mm_interconnect_2_id_router id_router (
	...
	de1_soc_mm_interconnect_2_cmd_xbar_demux cmd_xbar_demux (
		.clk                (pll_0_outclk0_clk),                                                //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_mm_interconnect_2_cmd_xbar_demux cmd_xbar_demux_001 (
		.clk                (pll_0_outclk0_clk),                                                //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_mm_interconnect_2_cmd_xbar_demux cmd_xbar_demux_002 (
		.clk                (pll_0_outclk0_clk),                                   //       clk.clk
		.reset              (plasma_soc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_mm_interconnect_2_cmd_xbar_mux cmd_xbar_mux (
		.clk                 (pll_0_outclk0_clk),                                   //       clk.clk
		.reset               (plasma_soc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_mm_interconnect_2_rsp_xbar_demux rsp_xbar_demux (
		.clk                (pll_0_outclk0_clk),                                   //       clk.clk
		.reset              (plasma_soc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_mm_interconnect_2_rsp_xbar_mux rsp_xbar_mux (
		.clk                 (pll_0_outclk0_clk),                                                //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_mm_interconnect_2_rsp_xbar_mux rsp_xbar_mux_001 (
		.clk                 (pll_0_outclk0_clk),                                                //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_mm_interconnect_2_rsp_xbar_mux rsp_xbar_mux_002 (
		.clk                 (pll_0_outclk0_clk),                                   //       clk.clk
		.reset               (plasma_soc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
