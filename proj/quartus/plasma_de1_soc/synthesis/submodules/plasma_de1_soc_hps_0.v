...
module plasma_de1_soc_hps_0 #(
		...
		output wire         sdmmc_vs_o,        //           sdio.vs_o
		output wire         sdmmc_pwr_ena_o,   //               .pwr_ena_o
		input  wire         sdmmc_wp_i,        //               .wp_i
		input  wire         sdmmc_cdn_i,       //               .cdn_i
		input  wire         sdmmc_card_intn_i, //               .card_intn_i
		input  wire         sdmmc_cmd_i,       //               .cmd_i
		output wire         sdmmc_cmd_o,       //               .cmd_o
		output wire         sdmmc_cmd_en,      //               .cmd_en
		input  wire [7:0]   sdmmc_data_i,      //               .data_i
		output wire [7:0]   sdmmc_data_o,      //               .data_o
		output wire [7:0]   sdmmc_data_en,     //               .data_en
		output wire         sdmmc_rstn_o,      //     sdio_reset.reset
		output wire         sdmmc_cclk_out,    //      sdio_cclk.clk
	...
	plasma_de1_soc_hps_0_fpga_interfaces fpga_interfaces (
		...
		.sdmmc_vs_o        (sdmmc_vs_o),        //           sdio.vs_o
		.sdmmc_pwr_ena_o   (sdmmc_pwr_ena_o),   //               .pwr_ena_o
		.sdmmc_wp_i        (sdmmc_wp_i),        //               .wp_i
		.sdmmc_cdn_i       (sdmmc_cdn_i),       //               .cdn_i
		.sdmmc_card_intn_i (sdmmc_card_intn_i), //               .card_intn_i
		.sdmmc_cmd_i       (sdmmc_cmd_i),       //               .cmd_i
		.sdmmc_cmd_o       (sdmmc_cmd_o),       //               .cmd_o
		.sdmmc_cmd_en      (sdmmc_cmd_en),      //               .cmd_en
		.sdmmc_data_i      (sdmmc_data_i),      //               .data_i
		.sdmmc_data_o      (sdmmc_data_o),      //               .data_o
		.sdmmc_data_en     (sdmmc_data_en),     //               .data_en
		.sdmmc_rstn_o      (sdmmc_rstn_o),      //     sdio_reset.reset
		.sdmmc_cclk_out    (sdmmc_cclk_out),    //      sdio_cclk.clk
	...
	plasma_de1_soc_hps_0_hps_io hps_io (
