...
module de1_soc_mm_interconnect_3 (
	...
	wire   [31:0] hps_to_plasma_dma_write_master_translator_avalon_universal_master_0_address;       // hps_to_plasma_dma_write_master_translator:uav_address -> hps_to_plasma_dma_write_master_agent:av_address
	...
	wire    [2:0] hps_to_plasma_dma_write_master_translator_avalon_universal_master_0_burstcount;    // hps_to_plasma_dma_write_master_translator:uav_burstcount -> hps_to_plasma_dma_write_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                 // rsp_mux:src_valid -> hps_to_plasma_dma_write_master_agent:rp_valid
	wire  [101:0] rsp_mux_src_data;                                                                  // rsp_mux:src_data -> hps_to_plasma_dma_write_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                 // hps_to_plasma_dma_write_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                               // rsp_mux:src_channel -> hps_to_plasma_dma_write_master_agent:rp_channel
	...
	wire  [101:0] rsp_mux_001_src_data;                                                              // rsp_mux_001:src_data -> dma_0_write_master_agent:rp_data
	...
	wire  [102:0] plasma_soc_0_avalon_slave_0_agent_rf_source_data;                                  // plasma_soc_0_avalon_slave_0_agent:rf_source_data -> plasma_soc_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [102:0] plasma_soc_0_avalon_slave_0_agent_rsp_fifo_out_data;                               // plasma_soc_0_avalon_slave_0_agent_rsp_fifo:out_data -> plasma_soc_0_avalon_slave_0_agent:rf_sink_data
	...
	wire          cmd_mux_src_valid;                                                                 // cmd_mux:src_valid -> plasma_soc_0_avalon_slave_0_agent:cp_valid
	wire  [101:0] cmd_mux_src_data;                                                                  // cmd_mux:src_data -> plasma_soc_0_avalon_slave_0_agent:cp_data
	wire          cmd_mux_src_ready;                                                                 // plasma_soc_0_avalon_slave_0_agent:cp_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                               // cmd_mux:src_channel -> plasma_soc_0_avalon_slave_0_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                                         // cmd_mux:src_startofpacket -> plasma_soc_0_avalon_slave_0_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                                           // cmd_mux:src_endofpacket -> plasma_soc_0_avalon_slave_0_agent:cp_endofpacket
	wire          hps_to_plasma_dma_write_master_agent_cp_valid;                                     // hps_to_plasma_dma_write_master_agent:cp_valid -> router:sink_valid
	wire  [101:0] hps_to_plasma_dma_write_master_agent_cp_data;                                      // hps_to_plasma_dma_write_master_agent:cp_data -> router:sink_data
	...
	wire  [101:0] dma_0_write_master_agent_cp_data;                                                  // dma_0_write_master_agent:cp_data -> router_001:sink_data
	...
	wire  [101:0] plasma_soc_0_avalon_slave_0_agent_rp_data;                                         // plasma_soc_0_avalon_slave_0_agent:rp_data -> router_002:sink_data
	...
	de1_soc_mm_interconnect_3_router router_001 (
	...
	de1_soc_mm_interconnect_3_router_002 router_002 (
	...
	de1_soc_mm_interconnect_3_cmd_demux cmd_demux_001 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                         //       clk.clk
		.reset              (hps_to_plasma_dma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_mm_interconnect_3_rsp_demux rsp_demux (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                         //       clk.clk
		.reset              (hps_to_plasma_dma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_mm_interconnect_3_rsp_mux rsp_mux_001 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                         //       clk.clk
		.reset               (hps_to_plasma_dma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
