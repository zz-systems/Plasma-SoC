...
module de1_soc_mm_interconnect_0 (
	...
	wire  [107:0] rsp_mux_src_data;                                                                // rsp_mux:src_data -> plasma_soc_0_avalon_master_0_agent:rp_data
	wire          rsp_mux_src_ready;                                                               // plasma_soc_0_avalon_master_0_agent:rp_ready -> rsp_mux:src_ready
	wire    [8:0] rsp_mux_src_channel;                                                             // rsp_mux:src_channel -> plasma_soc_0_avalon_master_0_agent:rp_channel
	...
	wire  [107:0] cmd_mux_001_src_data;                                                            // cmd_mux_001:src_data -> hex_0_s1_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                           // hex_0_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [8:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> hex_0_s1_agent:cp_channel
	...
	wire  [107:0] cmd_mux_002_src_data;                                                            // cmd_mux_002:src_data -> hex_1_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                           // hex_1_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [8:0] cmd_mux_002_src_channel;                                                         // cmd_mux_002:src_channel -> hex_1_s1_agent:cp_channel
	...
	wire  [107:0] cmd_mux_003_src_data;                                                            // cmd_mux_003:src_data -> hex_2_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                           // hex_2_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [8:0] cmd_mux_003_src_channel;                                                         // cmd_mux_003:src_channel -> hex_2_s1_agent:cp_channel
	...
	wire  [107:0] cmd_mux_004_src_data;                                                            // cmd_mux_004:src_data -> hex_3_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                           // hex_3_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                         // cmd_mux_004:src_channel -> hex_3_s1_agent:cp_channel
	...
	wire  [107:0] cmd_mux_005_src_data;                                                            // cmd_mux_005:src_data -> hex_4_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                           // hex_4_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [8:0] cmd_mux_005_src_channel;                                                         // cmd_mux_005:src_channel -> hex_4_s1_agent:cp_channel
	...
	wire  [107:0] cmd_mux_006_src_data;                                                            // cmd_mux_006:src_data -> hex_5_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                           // hex_5_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                         // cmd_mux_006:src_channel -> hex_5_s1_agent:cp_channel
	...
	wire  [107:0] plasma_soc_0_avalon_master_0_agent_cp_data;                                      // plasma_soc_0_avalon_master_0_agent:cp_data -> router:sink_data
	...
	wire   [89:0] sdram_controller_0_s1_agent_rp_data;                                             // sdram_controller_0_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [107:0] hex_0_s1_agent_rp_data;                                                          // hex_0_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [107:0] hex_1_s1_agent_rp_data;                                                          // hex_1_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [107:0] hex_2_s1_agent_rp_data;                                                          // hex_2_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [107:0] hex_3_s1_agent_rp_data;                                                          // hex_3_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [107:0] hex_4_s1_agent_rp_data;                                                          // hex_4_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [107:0] hex_5_s1_agent_rp_data;                                                          // hex_5_s1_agent:rp_data -> router_007:sink_data
	...
	wire    [8:0] sdram_controller_0_s1_burst_adapter_source0_channel;                             // sdram_controller_0_s1_burst_adapter:source0_channel -> sdram_controller_0_s1_agent:cp_channel
	...
	wire   [89:0] router_001_src_data;                                                             // router_001:src_data -> sdram_controller_0_s1_rsp_width_adapter:in_data
	wire          router_001_src_ready;                                                            // sdram_controller_0_s1_rsp_width_adapter:in_ready -> router_001:src_ready
	wire    [8:0] router_001_src_channel;                                                          // router_001:src_channel -> sdram_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire  [107:0] sdram_controller_0_s1_rsp_width_adapter_src_data;                                // sdram_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire    [8:0] sdram_controller_0_s1_rsp_width_adapter_src_channel;                             // sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire  [107:0] cmd_mux_src_data;                                                                // cmd_mux:src_data -> sdram_controller_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                               // sdram_controller_0_s1_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [8:0] cmd_mux_src_channel;                                                             // cmd_mux:src_channel -> sdram_controller_0_s1_cmd_width_adapter:in_channel
	...
	wire    [8:0] sdram_controller_0_s1_cmd_width_adapter_src_channel;                             // sdram_controller_0_s1_cmd_width_adapter:out_channel -> sdram_controller_0_s1_burst_adapter:sink0_channel
	...
	de1_soc_mm_interconnect_0_router_002 router_008 (
	...
	de1_soc_mm_interconnect_0_router_002 router_009 (
	...
	de1_soc_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                         //       clk.clk
		.reset               (plasma_soc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                         //       clk.clk
		.reset               (plasma_soc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                         //       clk.clk
		.reset              (plasma_soc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de1_soc_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                         //       clk.clk
		.reset              (plasma_soc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
