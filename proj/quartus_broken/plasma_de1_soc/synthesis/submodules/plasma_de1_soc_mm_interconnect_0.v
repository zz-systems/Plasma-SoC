// PLASMA_DE1_SOC_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module PLASMA_DE1_SOC_mm_interconnect_0 (
	...
	wire  [101:0] rsp_mux_src_data;                                                                // rsp_mux:src_data -> plasma_soc_0_avalon_master_0_agent:rp_data
	wire          rsp_mux_src_ready;                                                               // plasma_soc_0_avalon_master_0_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                             // rsp_mux:src_channel -> plasma_soc_0_avalon_master_0_agent:rp_channel
	...
	wire   [84:0] sdram_controller_0_s1_agent_rf_source_data;                                      // sdram_controller_0_s1_agent:rf_source_data -> sdram_controller_0_s1_agent_rsp_fifo:in_data
	...
	wire   [84:0] sdram_controller_0_s1_agent_rsp_fifo_out_data;                                   // sdram_controller_0_s1_agent_rsp_fifo:out_data -> sdram_controller_0_s1_agent:rf_sink_data
	...
	wire  [102:0] hex_0_s1_agent_rf_source_data;                                                   // hex_0_s1_agent:rf_source_data -> hex_0_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] hex_0_s1_agent_rsp_fifo_out_data;                                                // hex_0_s1_agent_rsp_fifo:out_data -> hex_0_s1_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_001_src_data;                                                            // cmd_mux_001:src_data -> hex_0_s1_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                           // hex_0_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> hex_0_s1_agent:cp_channel
	...
	wire  [101:0] plasma_soc_0_avalon_master_0_agent_cp_data;                                      // plasma_soc_0_avalon_master_0_agent:cp_data -> router:sink_data
	...
	wire   [83:0] sdram_controller_0_s1_agent_rp_data;                                             // sdram_controller_0_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [101:0] hex_0_s1_agent_rp_data;                                                          // hex_0_s1_agent:rp_data -> router_002:sink_data
	...
	wire   [83:0] sdram_controller_0_s1_burst_adapter_source0_data;                                // sdram_controller_0_s1_burst_adapter:source0_data -> sdram_controller_0_s1_agent:cp_data
	...
	wire    [1:0] sdram_controller_0_s1_burst_adapter_source0_channel;                             // sdram_controller_0_s1_burst_adapter:source0_channel -> sdram_controller_0_s1_agent:cp_channel
	...
	wire   [83:0] router_001_src_data;                                                             // router_001:src_data -> sdram_controller_0_s1_rsp_width_adapter:in_data
	wire          router_001_src_ready;                                                            // sdram_controller_0_s1_rsp_width_adapter:in_ready -> router_001:src_ready
	wire    [1:0] router_001_src_channel;                                                          // router_001:src_channel -> sdram_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire  [101:0] sdram_controller_0_s1_rsp_width_adapter_src_data;                                // sdram_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire    [1:0] sdram_controller_0_s1_rsp_width_adapter_src_channel;                             // sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire  [101:0] cmd_mux_src_data;                                                                // cmd_mux:src_data -> sdram_controller_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                               // sdram_controller_0_s1_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                             // cmd_mux:src_channel -> sdram_controller_0_s1_cmd_width_adapter:in_channel
	...
	wire   [83:0] sdram_controller_0_s1_cmd_width_adapter_src_data;                                // sdram_controller_0_s1_cmd_width_adapter:out_data -> sdram_controller_0_s1_burst_adapter:sink0_data
	...
	wire    [1:0] sdram_controller_0_s1_cmd_width_adapter_src_channel;                             // sdram_controller_0_s1_cmd_width_adapter:out_channel -> sdram_controller_0_s1_burst_adapter:sink0_channel
	...
	PLASMA_DE1_SOC_mm_interconnect_0_router router (
	...
	PLASMA_DE1_SOC_mm_interconnect_0_router_001 router_001 (
	...
	PLASMA_DE1_SOC_mm_interconnect_0_router_002 router_002 (
	...
	PLASMA_DE1_SOC_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                         //       clk.clk
		.reset              (plasma_soc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PLASMA_DE1_SOC_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                         //       clk.clk
		.reset               (plasma_soc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PLASMA_DE1_SOC_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                         //       clk.clk
		.reset               (plasma_soc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PLASMA_DE1_SOC_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                               //       clk.clk
		.reset              (plasma_soc_0_reset_sink_reset_bridge_in_reset_reset),       // clk_reset.reset
	...
	PLASMA_DE1_SOC_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                         //       clk.clk
		.reset              (plasma_soc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PLASMA_DE1_SOC_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                         //       clk.clk
		.reset               (plasma_soc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PLASMA_DE1_SOC_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
	...
	PLASMA_DE1_SOC_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
